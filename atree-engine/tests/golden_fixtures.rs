...
#[test] fn golden_php_calls() { let f = fixture!("../tests/fixtures/php/Controller.php", "php"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "PHP should extract calls"); assert!(calls.contains(&"render") || calls.contains(&"findAll"), "PHP calls should contain render/findAll, got: {:?}", calls); }
...
#[test] fn golden_csharp_calls() { let f = fixture!("../tests/fixtures/csharp/Service.cs", "cs"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "C# should extract calls"); assert!(calls.contains(&"FindById") || calls.contains(&"Render"), "C# calls should contain FindById/Render, got: {:?}", calls); }
...
#[test] fn golden_ruby_calls() { let f = fixture!("../tests/fixtures/ruby/service.rb", "rb"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "Ruby should extract calls"); assert!(calls.contains(&"render") || calls.contains(&"find_by_id"), "Ruby calls should contain render/find_by_id, got: {:?}", calls); }
...
#[test] fn golden_kotlin_calls() { let f = fixture!("../tests/fixtures/kotlin/Service.kt", "kt"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "Kotlin should extract calls"); assert!(calls.contains(&"render") || calls.contains(&"findById"), "Kotlin calls should contain render/findById, got: {:?}", calls); }
...
#[test] fn golden_swift_calls() { let f = fixture!("../tests/fixtures/swift/Service.swift", "swift"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "Swift should extract calls"); assert!(calls.contains(&"render") || calls.contains(&"findById"), "Swift calls should contain render/findById, got: {:?}", calls); }
...
#[test] fn golden_bash_calls() { let f = fixture!("../tests/fixtures/bash/deploy.sh", "sh"); let calls: Vec<&str> = f.calls.iter().map(|c| c.callee_name.as_str()).collect(); assert!(!calls.is_empty(), "Bash should extract calls"); assert!(calls.contains(&"echo") || calls.contains(&"log_message"), "Bash calls should contain echo/log_message, got: {:?}", calls); }
